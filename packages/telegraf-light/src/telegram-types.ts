...
import type { UnionKeys } from './deunionize'
import type { FmtString } from './format'
...
export type MessageSubType =
    | 'forward_date'
    | Exclude<UnionKeys<Message>, keyof Message.CaptionableMessage | 'entities' | 'media_group_id'>
