 ...
 */
export type NarrowedContext<C extends Context, U extends tg.Update> = Context<U> &
...
export class Context<U extends Deunionize<tg.Update> = tg.Update> {
    ...
    get senderChat() {
        return getMessageFromAnySource(this)?.sender_chat as Getter<U, 'sender_chat'>
    }
     ...
     */
    editMessageMedia(media: tt.WrapCaption<tg.InputMedia>, extra?: tt.ExtraEditMessageMedia) {
     ...
     */
    setChatAdministratorCustomTitle(...args: Shorthand<'setChatAdministratorCustomTitle'>) {
     ...
     */
    sendVideoNote(videoNote: string | tg.InputFileVideoNote, extra?: tt.ExtraVideoNote) {
     ...
     */
    sendChatAction(action: Shorthand<'sendChatAction'>[0], extra?: tt.ExtraSendChatAction) {
     ...
     */
    forwardMessage(chatId: string | number, extra?: Shorthand<'forwardMessage'>[2]) {
        const message = getMessageFromAnySource(this)
...
export type GetUpdateContent<U extends tg.Update> = U extends tg.Update.CallbackQueryUpdate
