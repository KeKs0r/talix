...
export const message =
    ...
    (update: Update): update is Update.MessageUpdate<Keyed<Message, Ks[number]>> => {
...
export const editedMessage =
    ...
    (
        update: Update
    ): update is Update.EditedMessageUpdate<Keyed<CommonMessageBundle, Ks[number]>> => {
...
export const channelPost =
    <Ks extends DistinctKeys<Message>[]>(...keys: Ks) =>
    (update: Update): update is Update.ChannelPostUpdate<Keyed<Message, Ks[number]>> => {
...
export const editedChannelPost =
    ...
    (
        update: Update
    ): update is Update.EditedChannelPostUpdate<Keyed<CommonMessageBundle, Ks[number]>> => {
...
export const callbackQuery =
    ...
    (update: Update): update is Update.CallbackQueryUpdate<Keyed<CallbackQuery, Ks[number]>> => {
