...
export class Telegram extends ApiClient {
    ...
    async getFileLink(fileId: string | tg.File) {
        ...
        /**
         * @MH: mocking of { isAbsolute } from 'path'
         */
     ...
     */
    sendMessage(chatId: number | string, text: string | FmtString, extra?: tt.ExtraReplyMessage) {
     ...
     */
    sendMediaGroup(chatId: number | string, media: tt.MediaGroup, extra?: tt.ExtraMediaGroup) {
     ...
     */
    stopPoll(chatId: number | string, messageId: number, extra?: tt.ExtraStopPoll) {
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format `@channelusername`)
     */
    promoteChatMember(chatId: number | string, userId: number, extra: tt.ExtraPromoteChatMember) {
     ...
     */
    restrictChatMember(chatId: string | number, userId: number, extra: tt.ExtraRestrictChatMember) {
    ...
    setChatAdministratorCustomTitle(chatId: number | string, userId: number, title: string) {
    ...
    createChatInviteLink(chatId: number | string, extra?: tt.ExtraCreateChatInviteLink) {
    ...
    setChatPhoto(chatId: number | string, photo: tg.Opts<'setChatPhoto'>['photo']) {
     ...
     * @param userId Unique identifier of the target user
     */
    unbanChatMember(chatId: number | string, userId: number, extra?: { only_if_banned?: boolean }) {
    ...
    answerCbQuery(callbackQueryId: string, text?: string, extra?: tt.ExtraAnswerCbQuery) {
     ...
     */
    createForumTopic(chat_id: number | string, name: string, extra?: tt.ExtraCreateForumTopic) {
     ...
     */
    uploadStickerFile(ownerId: number, stickerFile: tg.Opts<'uploadStickerFile'>['png_sticker']) {
     ...
     */
    addStickerToSet(ownerId: number, name: string, stickerData: tt.ExtraAddStickerToSet) {
     ...
     */
    setMyCommands(commands: readonly tg.BotCommand[], extra?: tt.ExtraSetMyCommands) {
    ...
    setPassportDataErrors(userId: number, errors: readonly tg.PassportElementError[]) {
     ...
     */
    getMyDefaultAdministratorRights({ forChannels }: { forChannels?: boolean } = {}) {
